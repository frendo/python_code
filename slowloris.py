...
# Here we are creating the sockets and establishing a HTTP connection with the server 
...
while True:
# here we are going to send small amounts of data ever 15 seconds on each socket that we have opened 
